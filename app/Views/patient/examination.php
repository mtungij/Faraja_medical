...
<section class="bg-gray-50 dark:bg-gray-900">
    <header>
        <h2 class="text-2xl font-bold my-3">Examinations</h2>
    </header>
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <?= $this->include('patient/partials/createExamination') ;?>
        ...
        <ol class="mx-4 relative border-s border-gray-300 dark:border-gray-700"> 
            <?php foreach ($examinations as $examination):?>                 
                <li class="mb-10 ms-4">
                    ...
                    <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"><?= date('d M Y', strtotime($examination->created_at)) ;?></time>
