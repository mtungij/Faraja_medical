...
<div class="w-full text-white bg-sky-500">
      ...
      <form action="<?php echo base_url("store_complain") ?>" method="post">
          ...
          <div class=" ">
             ...
             <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chief Complain</label>
