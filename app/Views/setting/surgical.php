  ...
  <div>
    <span class="font-medium">Angalizo kabla hujabonyeza button ya kudelete :</span>
      ...
      <li>kwa usalama wa taarifa za nyuma za wateja </li>
        <li>button ya kudelete itumike muda mchache baada ya kugundulika surgical zilizoingizwa muda huo huo kimakosa </li>
        <li>kabla ya watumiaji wa mfumo kutumia Surgical uliyoyasajili</li>
    </ul>
  </div>
  </div>
...
<div class="w-full">
          ...
          <a href="<?= site_url("delete_surgical/$value->id") ?>" class="mr-4 " title="Delete">
